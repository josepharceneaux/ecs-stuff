...
def create_widget_candidate(form, talent_pool_hash):
    ...
    military_service_dict['branch'] = form.get('militaryBranch')
    military_service_dict['status'] = form.get('militaryStatus')
    military_service_dict['highest_grade'] = form.get('militaryGrade')
    military_service_dict['to_date'] = form.get('militaryToDate')

    candidate_dict['military_services'] = [military_service_dict]

    # TODO consider logging the full dict.
