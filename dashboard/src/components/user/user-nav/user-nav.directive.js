(function () {
    ...
    angular.module('app.user')
        .directive('gtUserNav', directiveFunction)
        .controller('UserNavController', ControllerFunction);
    ...
    function directiveFunction() {
        ...
        var directive = {
            restrict: 'E',
            templateUrl: 'components/user/user-nav/user-nav.html',
            replace: true,
            scope: {},
    ...
    function ControllerFunction(logger) {
        ...
        function activate() {
            logger.log('Activated User Nav View');
        }
    }
