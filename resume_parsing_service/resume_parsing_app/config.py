...
if GT_ENVIRONMENT == 'dev':
    ...
    DEBUG = True
    LOGGER = logging.getLogger("resume_parsing_service.dev")
    ...
    CANDIDATE_CREATION_URI = 'http://127.0.0.1:8005/v1/candidates'
    DEBUG = True
    LOGGER = logging.getLogger("resume_parsing_service.ci")
    ...
    DEBUG = False
    LOGGER = logging.getLogger("resume_parsing_service.qa")
    ...
    DEBUG = False
    LOGGER = logging.getLogger("resume_parsing_service.prod")
else:
