...
class Activity(db.Model):
    ...
    class MessageIds(object):
        ...
        CANDIDATE_DOCUMENT_UPLOADED = 302
        CANDIDATE_DOCUMENT_DELETED = 303
        ...
        PIPELINE_ADD_CANDIDATE = 606
        PIPELINE_REMOVE_CANDIDATE = 607
...
class Frequency(db.Model):
    ...
    def get_seconds_from_id(cls, frequency_id):
        ...
        seconds_from_frequency_id = {
            ...
            cls.CUSTOM: 15 * SchedulerUtils.MIN_ALLOWED_FREQUENCY
        }
