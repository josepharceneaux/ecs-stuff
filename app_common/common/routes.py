...
class SocialNetworkApi(object):
    ...
    TOKEN_VALIDITY = RELATIVE_VERSION % 'social-networks/<int:_id>/token/validity'
    TOKEN_REFRESH = RELATIVE_VERSION % 'social-networks/<int:_id>/token/refresh'
    USER_SOCIAL_NETWORK_CREDENTIALS = RELATIVE_VERSION % 'social-networks/<int:_id>/user/credentials'
