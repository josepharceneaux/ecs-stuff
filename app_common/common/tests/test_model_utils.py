...
def test_get_fields():
    ...
    fields = Venue.get_fields(exclude=('address_line_2', 'zip_code', 'user_id'))
    ...
    expected_fields = ['address_line_1', 'city', 'country',
                       'events', ['social_network_event_id',  'base_campaign_id', 'social_network_id', 'user_id',
                                  'organizer_id', 'venue_id', 'social_network_group_id', 'group_url_name',
                                  'start_datetime', 'end_datetime', 'registration_instruction', 'max_attendees',
                                  'tickets_id', 'id', 'title', 'description', 'url', 'cost', 'currency', 'timezone']
                       ]
    assert fields == expected_fields
