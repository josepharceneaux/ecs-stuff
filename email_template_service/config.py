...
if GT_ENVIRONMENT == 'dev':
    ...
    LOGGER = logging.getLogger("email_template_service.dev")
    DEBUG = True
    ...
    LOGGER = logging.getLogger("email_template_service.ci")
    DEBUG = True
    ...
    LOGGER = logging.getLogger("email_template_service.qa")
    DEBUG = False
    ...
    LOGGER = logging.getLogger("email_template_service.prod")
    DEBUG = False
else:
