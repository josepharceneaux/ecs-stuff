...
printf "\n"
batch_one=`py.test -n 48 user_service/tests activity_service/tests spreadsheet_import_service/tests scheduler_service/tests auth_service/tests candidate_pool_service/tests push_campaign_service/tests`
