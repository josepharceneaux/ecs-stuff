...
py.test -n 48 scheduler_service/tests auth_service/tests user_service/tests activity_service/tests spreadsheet_import_service/tests sms_campaign_service/tests
