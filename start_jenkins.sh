...
# Temporary removed potential flaky tests -Amir
py.test -n 48 auth_service/tests user_service/tests candidate_pool_service/tests spreadsheet_import_service/tests email_campaign_service/tests resume_parsing_service/tests app_common/common/tests talentbot_service/tests social_network_service/tests
