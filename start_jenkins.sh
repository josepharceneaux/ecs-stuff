...
py.test -n auto scheduler_service/tests auth_service/tests user_service/tests activity_service/tests resume_parsing_service/tests candidate_pool_service/tests candidate_service/tests spreadsheet_import_service/tests email_campaign_service/tests sms_campaign_service/tests