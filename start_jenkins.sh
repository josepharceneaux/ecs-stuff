...
py.test -n 48 scheduler_service/tests auth_service/tests user_service/tests social_network_service/tests app_common/common/campaign_services/tests email_campaign_service/tests activity_service/tests sms_campaign_service/tests candidate_pool_service/tests spreadsheet_import_service/tests resume_parsing_service/tests social_network_service/tests app_common/common/tests talentbot_service/tests
