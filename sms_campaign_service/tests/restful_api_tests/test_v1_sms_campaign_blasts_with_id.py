...
Author: Hafiz Muhammad Basit, QC-Technologies, <basit.gettalent@gmail.com>
    ...
    This module contains pyTests for endpoint /v1/campaigns/:id/blasts/:id of
    SMS Campaign API.
"""
# Third Party
import requests
...
class TestSmsCampaignBlastsWithId(object):
    ...
    def test_get_with_deleted_campaign(self, auth_token, sms_campaign_of_current_user,
        ...
        CampaignsCommonTests.request_after_deleting_campaign(
            ...
            self.URL % ('%s', blast_id), self.METHOD, auth_token)

    def test_get_with_saved_blast(self, auth_token, sms_campaign_of_current_user,
        ...
        assert_ok_response_and_counts(response, entity=self.ENTITY, check_count=False)
    ...
    def test_get_with_blast_id_associated_with_not_owned_campaign(
            self, auth_token, sms_campaign_of_current_user, create_blast_for_not_owned_campaign):
        """
    ...
    def test_get_with_invalid_campaign_id(self, auth_token, create_sms_campaign_blast):
        """
        ...
        CampaignsCommonTests.request_with_invalid_campaign_id(
            SmsCampaign, self.METHOD, self.URL % ('%s', create_sms_campaign_blast.id), auth_token,
            None)

    def test_get_with_invalid_blast_id(self, auth_token, sms_campaign_of_current_user):
        """
