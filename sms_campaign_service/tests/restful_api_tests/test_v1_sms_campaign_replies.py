...
class TestSmsCampaignReplies(object):
    ...
    def test_get_with_invalid_token(self, sms_campaign_of_user_first):
        ...
        :param sms_campaign_of_user_first: fixture to create SMS campaign for current user
        """
    ...
    def test_get_with_no_replies_on_campaign(self, headers,
        ...
        """
        response = requests.get(self.URL % sms_campaign_of_user_first['id'], headers=headers)
    ...
    def test_get_with_valid_token_and_one_reply(self, candidate_and_phone_1,
        ...
        for received_reply_object in received_reply_objects:
            assert_valid_reply_object(received_reply_object, blast_ids[0],
                                      [candidate_and_phone_1[1]['id']])
