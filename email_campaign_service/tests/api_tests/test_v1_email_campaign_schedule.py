...
class TestCampaignSchedule(object):
    ...
    def test_schedule_campaign_with_no_start_datetime(self, access_token_first, smartlist_user1_domain1_in_db):
        """
    ...
    def test_with_start_datetime_greater_than_end_datetime(self, access_token_first, smartlist_user1_domain1_in_db):
        """
