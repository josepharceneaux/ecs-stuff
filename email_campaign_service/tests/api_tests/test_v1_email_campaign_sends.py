...
class TestEmailCampaignSends(object):
    ...
    def test_get_by_sending_campaign(self, access_token_first, sent_campaign):
        ...
        """
        assert_blast_sends(sent_campaign, 2, abort_time_for_sends=120)
    ...
    def test_get_sends_with_paginated_response(self, access_token_first, sent_campaign_to_ten_candidates):
        ...
        """
        assert_blast_sends(sent_campaign_to_ten_candidates, 4, abort_time_for_sends=160)
        ...
        assert_blast_sends(sent_campaign_to_ten_candidates, 8, abort_time_for_sends=100)
        ...
        assert_blast_sends(sent_campaign_to_ten_candidates, 9, abort_time_for_sends=100)
