...
class TestEmailCampaignSends(object):
    ...
    def test_get_sends_with_paginated_response(self, access_token_first, sent_campaign_to_ten_candidates):
        ...
        """
        CampaignsTestsHelpers.assert_blast_sends(sent_campaign_to_ten_candidates, 4)
        ...
        CampaignsTestsHelpers.assert_blast_sends(sent_campaign_to_ten_candidates, 8)
        ...
        CampaignsTestsHelpers.assert_blast_sends(sent_campaign_to_ten_candidates, 9)
