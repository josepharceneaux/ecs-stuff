...
class TestEmailCampaignSends(object):
    ...
    def test_get_sends_with_paginated_response(self, access_token_first, sent_campaign_to_ten_candidates):
        ...
        """
        get_polled_sends(sent_campaign_to_ten_candidates, 4)
        ...
        get_polled_sends(sent_campaign_to_ten_candidates, 8)
        ...
        get_polled_sends(sent_campaign_to_ten_candidates, 9)
