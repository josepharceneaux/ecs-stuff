...
def process_campaign_send(celery_result, user_id, campaign_id, list_ids, new_candidates_only=False):
    ...
    subscribed_candidate_ids, unsubscribed_candidates_ids = get_subscribed_candidate_ids(campaign, all_candidate_ids, new_candidates_only)
...
def get_email_campaign_candidate_ids_and_emails(campaign, smartlist_ids, new_candidates_only=False):
    ...
    subscribed_candidate_ids, unsubscribed_candidates = get_subscribed_candidate_ids(campaign, all_candidate_ids, new_candidates_only)
    return get_priority_emails(campaign.user, subscribed_candidate_ids), unsubscribed_candidates
...
def _update_blast_unsubscribed_candidates(blast_id, unsubscribed_candidates):
    """
    This updates the email campaign blast object with number of unsubscribed_candidates.
    :param blast_id: Id of blast object.
...
def get_subscribed_candidate_ids(campaign, all_candidate_ids, new_candidates_only=False):
    ...
    logger.info("Email campaign id is: %s. number of unsubscribed candidate is: %s. unsubscribed candidate's ids are:"
