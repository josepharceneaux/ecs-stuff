...
if GT_ENVIRONMENT == 'dev':
    ...
    LOGGER = logging.getLogger("user_service.dev")
    DEBUG = True
    ...
    OAUTH_SERVER_URI = 'http://0.0.0.0:8001/oauth2/authorize'
    LOGGER = logging.getLogger("user_service.ci")
    DEBUG = True
