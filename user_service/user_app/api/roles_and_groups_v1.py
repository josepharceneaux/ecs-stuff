...
from user_service.common.models.user import User, Domain, UserRoles, UserGroup, db, Permission
...
class UserScopedRolesApi(Resource):
    ...
    @require_any_permission('SELF', Permission.PermissionNames.CAN_GET_USER_ROLES)
    def get(self, **kwargs):
        """
        ...
        user_roles = UserRoles.get_all_roles_of_user(requested_user_id)
        return {"roles": [user_scoped_role.role_id for user_scoped_role in user_roles]}

    @require_all_permissions(Permission.PermissionNames.CAN_ADD_USER_ROLES)
    def post(self, **kwargs):
        ...
        UserRoles.add_roles(requested_user, posted_data.get('roles'))
        return {"success_message": "All given roles have been added successfully"}

    @require_all_permissions(Permission.PermissionNames.CAN_DELETE_USER_ROLES)
    def delete(self, **kwargs):
        ...
        UserRoles.delete_roles(requested_user, posted_data.get('roles'))
...
class UserGroupsApi(Resource):
    ...
    @require_any_permission(Permission.PermissionNames.CAN_GET_GROUP_USERS, Permission.PermissionNames.CAN_EDIT_OTHER_DOMAIN_INFO)
    def get(self, **kwargs):
        """
    ...
    @require_any_permission(Permission.PermissionNames.CAN_ADD_GROUP_USERS, Permission.PermissionNames.CAN_EDIT_OTHER_DOMAIN_INFO)
    def post(self, **kwargs):
        """
...
class DomainGroupsApi(Resource):
    ...
    @require_any_permission(Permission.PermissionNames.CAN_GET_DOMAIN_GROUPS, Permission.PermissionNames.CAN_EDIT_OTHER_DOMAIN_INFO)
    def get(self, **kwargs):
        """
    ...
    @require_any_permission(Permission.PermissionNames.CAN_ADD_DOMAIN_GROUPS, Permission.PermissionNames.CAN_EDIT_OTHER_DOMAIN_INFO)
    def post(self, **kwargs):
        """
    ...
    @require_any_permission(Permission.PermissionNames.CAN_EDIT_DOMAIN_GROUPS, Permission.PermissionNames.CAN_EDIT_OTHER_DOMAIN_INFO)
    def put(self, **kwargs):
        """
    ...
    @require_any_permission(Permission.PermissionNames.CAN_DELETE_DOMAIN_GROUPS, Permission.PermissionNames.CAN_EDIT_OTHER_DOMAIN_INFO)
    def delete(self, **kwargs):
        """
