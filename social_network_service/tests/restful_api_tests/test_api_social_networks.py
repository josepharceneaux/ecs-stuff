...
#                                    api_url='https://www.eventbriteapi.com/')
...
#         facebook_credentials = UserCredentials(user_id=user.id, social_network_id=facebook.id,
#                             access_token='lorel ipsum', refresh_token='lorel ipsum')
...
#         eventbrite_credentials = UserCredentials(user_id=user.id, social_network_id=eventbrite.id,
#                             access_token='lorel ipsum', refresh_token='lorel ipsum')
