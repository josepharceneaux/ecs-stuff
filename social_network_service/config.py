...
if os.environ.get('GT_ENVIRONMENT') == 'dev':
    ...
    LOGGER = logging.getLogger("social_network_service.web_dev")
    DEBUG = True
    ...
    LOGGER = logging.getLogger("social_network_service.web_ci")
    DEBUG = True
    ...
    LOGGER = logging.getLogger("social_network_service.web_qa")
    DEBUG = False
    ...
    LOGGER = logging.getLogger("social_network_service.web_prod")
    DEBUG = False
else:
