...
from social_network_service.common.utils.api_utils import api_route, ApiResponse, generate_response_headers
...
class Events(Resource):
    ...
    def get(self):
        ...
        headers = generate_response_headers(len(events), per_page, page)
        if events:
