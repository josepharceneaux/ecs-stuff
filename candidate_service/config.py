...
if GT_ENVIRONMENT == 'dev':
    ...
    LOGGER = logging.getLogger("search_service.dev")
    DEBUG = True
    ...
    LOGGER = logging.getLogger("search_service.ci")
    DEBUG = True
    ...
    LOGGER = logging.getLogger("search_service.qa")
    DEBUG = False
    ...
    LOGGER = logging.getLogger("search_service.prod")
    DEBUG = False
else:
