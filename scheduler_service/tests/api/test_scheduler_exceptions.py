...
class TestSchedulerExceptions:
    ...
    def test_incomplete_post_data_exception(self, auth_header, job_config_periodic):
        """
        ...
        invalid_job_config = job_config_periodic.copy()
    ...
    def test_incorrect_post_data_exception(self, auth_header, job_config_periodic):
        """
    ...
    def test_invalid_task_type_exception(self, auth_header, job_config_periodic):
        """
        ...
        job_config_periodic['task_type'] = 'Some invalid type'
